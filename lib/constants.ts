...
export const Sponsors = [
  ...
  { src: "/sponsers/gokul.jpeg", alt: "Gokul Doodh", bg: true },
  { src: "/sponsers/graphix.png", alt: "Graphix", bg: true },
  { src: "/sponsers/gruhataran.jpeg", alt: "Gruhataran", bg: true },
  { src: "/sponsers/himalaya.jpeg", alt: "Himalaya Agencies", bg: true },
  { src: "/sponsers/krmotors.png", alt: "KR Motors", bg: true },
  { src: "/sponsers/motohaus.png", alt: "Motohaus", bg: true },
  { src: "/sponsers/pratik-jewellers.jpeg", alt: "Pratik Jewellers", bg: true },
  { src: "/sponsers/purtvi.png", alt: "Pruthvi Ventures", bg: true },
  { src: "/sponsers/vada.png", alt: "Shreemant Vada", bg: true },
  { src: "/sponsers/turf.png", alt: "Turf", bg: true },
];
